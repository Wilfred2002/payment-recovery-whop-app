...
export default function SettingsClient({
	...
	return (
		<div className="min-h-screen bg-mint-50 dark:bg-gray-900 flex flex-col">
			...
			<div className="flex-1 px-4 py-4">
				<div className="max-w-5xl mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						{/* Left: Form */}
						<div className="bg-white dark:bg-gray-900 rounded-lg border border-mint-200 dark:border-mint-700 p-4 sm:p-6 shadow-sm">
							...
							<div className="mb-6">
								...
								<input
									...
									className="w-full px-4 py-2 border border-mint-200 dark:border-mint-700 rounded-md focus:outline-none focus:ring-2 focus:ring-mint-500 dark:focus:ring-mint-500 text-sm text-black dark:text-gray-300"
							...
							<div className="mb-6">
								...
								<textarea
									...
									rows={12}
									className="w-full px-4 py-2 border border-mint-200 dark:border-mint-700 rounded-md focus:outline-none focus:ring-2 focus:ring-mint-500 dark:focus:ring-mint-500 text-sm font-mono text-black dark:text-gray-300"
									placeholder="Email body text"
									required
								/>
								<p className="text-xs text-black dark:text-gray-300 mt-2">
									Available variables: <code className="bg-mint-100 dark:bg-mint-800 px-1 rounded text-black dark:text-gray-300">{`{name}`}</code>,{" "}
									<code className="bg-mint-100 dark:bg-mint-800 px-1 rounded text-black dark:text-gray-300">{`{amount}`}</code>, <code className="bg-mint-100 dark:bg-mint-800 px-1 rounded text-black dark:text-gray-300">{`{updateLink}`}</code> (required)
								</p>
							</div>
							...
							<div className="flex gap-3">
								<button
									onClick={handleSave}
									disabled={saving}
									className="flex-1 bg-mint-700 hover:bg-mint-800 dark:bg-mint-700 dark:hover:bg-mint-600 text-white dark:text-white font-semibold px-6 py-3 rounded-md transition-colors font-[family-name:var(--font-space-mono)] uppercase tracking-wider text-sm disabled:opacity-50"
								>
									{saving ? "Saving..." : "Save Changes"}
								</button>
								<button
									onClick={handleReset}
									className="bg-white hover:bg-gray-50 dark:bg-mint-900 dark:hover:bg-gray-700 text-mint-700 dark:text-mint-300 dark:text-mint-300 font-semibold px-6 py-3 rounded-md border border-mint-200 dark:border-mint-700 transition-colors font-[family-name:var(--font-space-mono)] uppercase tracking-wider text-sm"
								>
									Reset
								</button>
							</div>
						...
						<div className="bg-white dark:bg-gray-900 rounded-lg border border-mint-200 dark:border-mint-700 p-4 sm:p-6 shadow-sm">
							...
							<div className="border border-mint-200 dark:border-mint-700 rounded-md p-3 sm:p-4 bg-white dark:bg-gray-900">
								<div className="mb-3 pb-3 border-b border-mint-200 dark:border-mint-700">
					...
					<div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-xl">
						...
						<div className="flex gap-3">
							...
							<button
								...
								className="flex-1 bg-mint-100 hover:bg-mint-200 dark:bg-mint-800 dark:hover:bg-mint-700 text-mint-700 dark:text-mint-300 dark:text-mint-300 font-semibold px-6 py-3 rounded-md border border-mint-300 dark:border-mint-700 transition-colors font-[family-name:var(--font-space-mono)] uppercase tracking-wider text-sm"
							>
								Cancel
							</button>
						</div>
