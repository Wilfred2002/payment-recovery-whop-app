			...
			<div className="min-h-screen bg-mint-50 dark:bg-mint-800 flex flex-col">
				...
				<div className="flex-1 flex items-center justify-center px-8">
					<div className="text-center max-w-md">
						...
						<div className="bg-white dark:bg-mint-900 border border-mint-200 dark:border-mint-700 dark:border-mint-700 rounded-lg p-6 shadow-sm text-left mb-6">
			...
			<div className="flex-1">
				...
				<div className="flex flex-col lg:flex-row gap-3">
					...
					<main className="flex-1 min-w-0">
						<div className="bg-white dark:bg-mint-900 border border-mint-200 dark:border-mint-700 dark:border-mint-700 rounded-lg overflow-hidden shadow-sm">
							<div className="px-4 py-3 border-b border-mint-200 dark:border-mint-700 bg-mint-50 dark:bg-mint-800">
							...
							<div className="overflow-x-auto">
								<table className="min-w-full">
									<thead>
										<tr className="border-b border-mint-100 dark:border-mint-700 bg-mint-50 dark:bg-mint-800">
...
function StatCard({
	...
	return (
		<div className={`${bgColor} dark:bg-mint-900 rounded-lg p-2 sm:p-3 border border-mint-200 dark:border-mint-700 shadow-sm`}>
...
function StatusBadge({ status }: { status: string }) {
	const styles = {
		...
		lost: "bg-gray-100 dark:bg-mint-800 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-mint-700",
	};

	return (
		<span
			className={`px-2.5 py-0.5 inline-flex text-xs font-semibold rounded border font-(family-name:--font-space-mono) uppercase ${styles[status as keyof typeof styles] || "bg-gray-50 dark:bg-mint-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-mint-700"}`}
		>
			{status}
		</span>
	);
