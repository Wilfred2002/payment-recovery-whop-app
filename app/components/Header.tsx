...
export default function Header({ showNav = false, companyId }: HeaderProps) {
	...
	return (
		<header className="px-4 sm:px-8 py-4 border-b border-mint-100 dark:border-neutral-800 bg-white dark:bg-[oklch(21%_0.006_285.885)]">
			<div className="flex items-center justify-between">
				<h1 className="text-2xl sm:text-4xl font-bold text-mint-700 dark:text-neutral-400 font-[family-name:var(--font-space-mono)] uppercase tracking-tight">
					Rebound
				</h1>
						...
						<Link
							...
							className={`text-sm font-semibold font-[family-name:var(--font-space-mono)] uppercase tracking-wider transition-colors ${
								isActive("/dashboard") || isActive("/discover/dashboard")
									? "text-mint-700 dark:text-neutral-400 border-b-2 border-mint-700 dark:border-neutral-400"
									: "text-mint-600 dark:text-neutral-400 hover:text-mint-700 dark:hover:text-neutral-300"
							}`}
						>
							Dashboard
						</Link>
